...
SIZE_FOR_READ = 65536
server_address = "192.168.100.6"
client_address = "127.0.0.1"#"192.168.100.6"
port = 0
...
def initializeSock(): #+
    ...
    print(f"Initialize completed (address: {client_address}, port: {port})")
    return sock
